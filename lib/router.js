...
PostsListController = RouteController.extend({
  ...
  onBeforeAction: function() {
    Meteor.subscribe('posts', Session.get('postsLimit'), Session.get('postOrder'), Session.get('activeTag'));
    infiniteScroll();
    this.next();
  },
  data: postSort
...
PostsWithResponsesController = RouteController.extend({
  ...
  onBeforeAction: function () {
    Meteor.subscribe('postsWithResponses', Session.get('postsLimit'), Session.get('postOrder'), Session.get('activeTag'));
    infiniteScroll();
    this.next();
  },
  data: postSort
...
PostsInProgressController = RouteController.extend({
  ...
  onBeforeAction: function () {
    Meteor.subscribe('postsInProgress', Session.get('postsLimit'), Session.get('postOrder'), Session.get('activeTag'));
    infiniteScroll();
    this.next();
  },
  data: postSort
...
PendingPostsController = RouteController.extend({
  onBeforeAction: function () {
    Meteor.subscribe('pendingPosts');
    infiniteScroll();
    this.next();
  },
  data: postSort
...
Router.map(function() {
  ...
  this.route('pendingPost', {
    path: '/pendingPost',
    template: 'pendingPost'
  });
